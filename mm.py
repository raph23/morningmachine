...
# end points
WEATHER_CONDITIONS_ENDPOINT = "http://api.wunderground.com/api/48d8773087e4e4b3/conditions/q/MA/Boston.json"
WEATHER_HOURLY_ENDPOINT = "http://api.wunderground.com/api/48d8773087e4e4b3/hourly/q/MA/Boston.json"
MBTA_ENDPOINT = "http://realtime.mbta.com/developer/api/v2/predictionsbystop"
IFTTT_ENDPOINT = "https://maker.ifttt.com/trigger/mm_r/with/key/cjUgYwAXhNgTImG2ELiEqs"

# mbta API info
MBTA_FORMAT = "json"
MBTA_TOKEN = "hQ17ayw29EmvWj-o9UzpMg"
